...
- Tabuleiro 9x9 com layout visual.
- Validação de movimentos conforme as regras do Sudoku.
- Células fixas não editáveis.
- Mensagens de erro para entradas inválidas.
- Alerta de vitória ao completar o tabuleiro.

## 🛠️ Tecnologias utilizadas

- Java (JDK 8 ou superior)
- Java Swing (interface gráfica nativa do Java)

## 📦 Como executar

### ✅ Pré-requisitos

- Ter o Java instalado (JDK 8+)
